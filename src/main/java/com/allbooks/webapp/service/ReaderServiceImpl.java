...
public class ReaderServiceImpl implements ReaderService {
	...
	public boolean saveReader(Reader theReader) {
		...
		if (!checkReaderLogin(theReader.getUsername())) {
			...
			Reader reader = restTemplate.getForObject(serviceUrlName + "/readers/logins/{readerLogin}", Reader.class, params);
	...
	public Rating checkIfRated(int id, String bookName) {
		...
		Rating rating = restTemplate.getForObject(serviceUrlName + "/readers/{readerId}/books/{bookId}/ratings", Rating.class,
				params);
	...
	public List<Comment> getReviewComments(int reviewId) {
		...
		ResponseEntity<Comment[]> responseEntity = restTemplate.getForEntity(serviceUrlName + "/reviews/{reviewId}/comments",
	...
	public void saveReaderBook(ReaderBook readerBook) {
		...
		restTemplate.postForObject(serviceUrlName + "/readerbooks", readerBook, ReaderBook.class);
	...
	public List<ReaderBook> getReaderBooks(int id) {
		...
		ResponseEntity<ReaderBook[]> responseEntity = restTemplate.getForEntity(serviceUrlName + "/readers/{readerId}/readerbooks",
				ReaderBook[].class, params);
		ReaderBook[] readerBooks = responseEntity.getBody();

		List<ReaderBook> readerBooksList = Arrays.asList(readerBooks);
	...
	public VerificationToken getTokenByReaderId(int readerId) {
		...
		VerificationToken verificationToken = restTemplate.getForObject(serviceUrlName + "/readers/{readerId}/verificationTokens",
	...
	public void deleteTokenById(int tokenId) {
		...
		restTemplate.delete(serviceUrlName + "/readers/verificationTokens/{tokenId}", params);
	}
	...
	public List<Review> getReaderReviews(String username) {
		...
		ResponseEntity<Review[]> reviews = restTemplate.getForEntity(serviceUrlName + "/readers/{username}/books/reviews",
				Review[].class, params);
