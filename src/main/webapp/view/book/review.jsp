...
<link type="text/css" rel="stylesheet" href="/css/book/review.css" />
...
<body>
	...
	<div id="container">
		...
		<div style="clear: both">
			...
			<sec:authorize access="isFullyAuthenticated()">
				<form action="/readerPost/postComment" name="commentText"
					method="POST">
					<input type="hidden" name="reviewId" value="${review.id}" />
					<input type="hidden" name="bookId" value="${review.book.id}" />
					Comment<br>
					<textarea name="commentText" id="reviewBox" required="required"></textarea>
					<br>
					<input class="submit" type="submit" value="Submit">
				</form>
			</sec:authorize>
